...
import { Link, useDisclosure, Button, Collapse, Box, Image, Text } from "@chakra-ui/react";
  ...
  return (
    <>
      ...
      >
        ...
        {!isToggleOpen ? <TriangleDownIcon position={"absolute"} zIndex="0" right={"17px"} fontSize={"13px"} /> : <TriangleUpIcon position={"absolute"} zIndex="0" right={"17px"} fontSize={"13px"} /> }
      </Button>
